...
def build_single_model_ui(models, add_promotion_links=False):
    promotion = (
        """
- Llama 2 簡介：下一代開源大型語言模式。 [[網站]](https://ai.meta.com/llama/)
- Vicuna：開源聊天機器人，具有90% ChatGPT的品質，足以讓GPT-4驚豔。 [[Blog]](https://lmsys.org/blog/2023-03-30-vicuna/)
...
### 使用條款
使用此服務，使用者必須同意以下條款： 本服務乃研究預覽，僅供非商業用途。僅提供有限的安全措施，並可能產生令人反感的內容。 不得將其用於任何非法、有害、暴力、種族主義或性目的。 本服務可能會收集使用者對話數據，並保留根據知識共享歸屬 (CC-BY) 授權分發該資料的權利。
